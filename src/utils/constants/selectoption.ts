...
export const DIARRHEAS = ["下痢も嘔吐もなし","軽い下痢","頻繁な下痢","激しい下痢", "軽い嘔吐", "頻繁な嘔吐", "激しい嘔吐", "嘔吐を伴う激しい嘔吐"]; //下痢、嘔吐
export const COUGHS = ["咳なし","軽い咳","動くと咳き込む","セーざーヒューヒュー音の咳","苦しそうな頻繁な咳"]; //咳
export const SKINS = ["皮膚の異常なし","発疹がある","乾燥している"]; //皮膚の状況
